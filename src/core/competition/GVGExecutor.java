...
public class GVGExecutor {
    ...
    public static void printHelp()
    {
        ...
        System.out.println("\t-ag MCTSVoice name to execute.\n" +
                "\t\t[Mandatory]\n" +
                "\t\t[Only one agent]\n" +
                "\t\t[Ex: -ag tracks.singlePlayer.deprecated.sampleMCTS.MCTSVoice]" +
                "\t\t[Ex for HUMANS: -ag tracks.singlePlayer.tools.human.MCTSVoice]");
        ...
        System.out.printf("\tComplete example:\n" +
                "\t\tjava GVGExecutor -g examples/gridphysics/aliens.txt:examples/gridphysics/sokoban.txt -l examples/gridphysics/aliens_lvl0.txt;examples/gridphysics/aliens_lvl1.txt:examples/gridphysics/sokoban_lvl0.txt;examples/gridphysics/sokoban_lvl1.txt;examples/gridphysics/sokoban_lvl2.txt -ag tracks.singlePlayer.deprecated.sampleMCTS.MCTSVoice -res output_game1.txt:output_game2.txt -seed 1342:3513 -vis 1 -rep 5");

        //Other examples:
        // -g examples/gridphysics/aliens.txt -l examples/gridphysics/aliens_lvl0.txt -ag tracks.singlePlayer.deprecated.sampleMCTS.MCTSVoice -res output_game1.txt -sds 1342 -vis 1 -rep 1
        // -g examples/gridphysics/aliens.txt -l examples/gridphysics/aliens_lvl0.txt:examples/gridphysics/aliens_lvl1.txt -ag tracks.singlePlayer.deprecated.sampleMCTS.MCTSVoice -res output_game1.txt -sds 1342 -vis 1 -rep 2
        // -g examples/gridphysics/aliens.txt -l examples/gridphysics/aliens_lvl0.txt -ag tracks.singlePlayer.deprecated.sampleMCTS.MCTSVoice -res output_game1.txt -vis 0 -rep 1
        // -g examples/gridphysics/aliens.txt:examples/gridphysics/camelRace.txt -l examples/gridphysics/aliens_lvl0.txt:examples/gridphysics/aliens_lvl1.txt;examples/gridphysics/camelRace_lvl0.txt -ag tracks.singlePlayer.deprecated.sampleMCTS.MCTSVoice -res o1.txt:o2.txt -sds 1342:111 -vis 1 -rep 2
        // -g examples/gridphysics/aliens.txt:examples/gridphysics/camelRace.txt -l examples/gridphysics/aliens_lvl0.txt:examples/gridphysics/aliens_lvl1.txt;examples/gridphysics/camelRace_lvl0.txt -ag tracks.singlePlayer.deprecated.sampleMCTS.MCTSVoice -res o1.txt:o2.txt -vis 0 -rep 2
    }
