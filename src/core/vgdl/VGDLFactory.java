    ...
    private String[] effectStrings = new String[]
            {
                    ...
                    "transformToAll", "addTimer", "killIfFrontal", "killIfNotFrontal", "killIfScoreNegative", "spawnBehind",
    ...
    private Class[] effectClasses = new Class[]
            {
                    ...
                    TransformToAll.class, AddTimer.class, KillIfFrontal.class, KillIfNotFrontal.class, KillIfScoreNegative.class, SpawnBehind.class, UpdateSpawnType.class,
