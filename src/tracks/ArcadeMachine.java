...
public class ArcadeMachine {
    ...
    public static double[] runOneGame(String game_file, String level_file, boolean visuals, String agentNames,
		...
		if (no_players > 1 && no_players != names.length) {
			...
			newNames[i] = "tracks.multiPlayer.tools.human.MCTSVoice";
			names = newNames;
		}
    ...
    public static double[] replayGame(String game_file, String level_file, boolean visuals, String actionFile) {
		...
		if (toPlay.getNoPlayers() > 1) {
			// multi player
			agentName = "tracks.multiPlayer.tools.replayer.MCTSVoice";
		} else {
			// single player
			agentName = "tracks.singlePlayer.tools.replayer.MCTSVoice";
		}
    ...
    public static final boolean isHuman(String agentName) {
		if (agentName.equalsIgnoreCase("tracks.multiPlayer.tools.human.MCTSVoice")
			|| agentName.equalsIgnoreCase("tracks.singlePlayer.tools.human.MCTSVoice"))
			return true;
		return false;
	}
