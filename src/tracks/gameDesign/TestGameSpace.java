...
public class TestGameSpace {
    ...
    public static void main(String[] args) {
        ...
        String sampleRandomController = "tracks.singlePlayer.simple.sampleRandom.MCTSVoice";
        String doNothingController = "tracks.singlePlayer.simple.doNothing.MCTSVoice";
        String sampleOneStepController = "tracks.singlePlayer.simple.sampleonesteplookahead.MCTSVoice";
        String sampleMCTSController = "tracks.singlePlayer.deprecated.sampleMCTS.MCTSVoice";
        String sampleFlatMCTSController = "tracks.singlePlayer.simple.greedyTreeSearch.MCTSVoice";
        String sampleOLMCTSController = "tracks.singlePlayer.advanced.sampleMCTS.MCTSVoice";
        String sampleGAController = "tracks.singlePlayer.deprecated.sampleGA.MCTSVoice";
        String sampleOLETSController = "tracks.singlePlayer.advanced.olets.MCTSVoice";
        String repeatOLETS = "tracks.singlePlayer.tools.repeatOLETS.MCTSVoice";
