...
public class TestMultiGameSpace {
    ...
    public static void main(String[] args) {
        // Available tracks:
        String doNothingController = "tracks.multiPlayer.simple.doNothing.MCTSVoice";
        String randomController = "tracks.multiPlayer.simple.sampleRandom.MCTSVoice";
        String oneStepController = "tracks.multiPlayer.simple.sampleOneStepLookAhead.MCTSVoice";
        String sampleMCTSController = "tracks.multiPlayer.deprecated.sampleMCTS.MCTSVoice";
        String sampleOLMCTSController = "tracks.multiPlayer.deprecated.sampleMCTS.MCTSVoice";
        String sampleGAController = "tracks.multiPlayer.deprecated.sampleGA.MCTSVoice";
        String humanController = "tracks.multiPlayer.tools.human.MCTSVoice";

        String sampleRHEA = "tracks.multiPlayer.advanced.sampleRHEA.MCTSVoice";
        String sampleRS = "tracks.multiPlayer.advanced.sampleRS.MCTSVoice";
