...
public class SharedData {
	 ...
	 */
	public static final String AGENT_NAME = "tracks.singlePlayer.tools.repeatOLETS.MCTSVoice";
	/**
	 * The name of a naive agent
	 */
	public static final String NAIVE_AGENT_NAME = "tracks.singlePlayer.simple.sampleonesteplookahead.MCTSVoice";
	/**
