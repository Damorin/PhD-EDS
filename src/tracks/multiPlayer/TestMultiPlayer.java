...
public class TestMultiPlayer {
    ...
    public static void main(String[] args) {
		...
		String sampleMCTSController = "tracks.multiPlayer.advanced.sampleMCTS.MCTSVoice";
		String sampleRSController = "tracks.multiPlayer.advanced.sampleRS.MCTSVoice";
		String sampleRHEAController = "tracks.multiPlayer.advanced.sampleRHEA.MCTSVoice";
