...
public class SharedData {
	 ...
	 */
	public static final String BEST_AGENT_NAME = "tracks.singlePlayer.advanced.olets.MCTSVoice";
	/**
	 * The name of a naive agent
	 */
	public static final String NAIVE_AGENT_NAME = "tracks.singlePlayer.advanced.sampleMCTS.MCTSVoice";
	/**
	 * The name of the random agent
	 */
	public static final String RANDOM_AGENT_NAME = "tracks.singlePlayer.simple.simpleRandom.MCTSVoice";
	/**
	 * The name of the do nothing agent
	 */
	public static final String DO_NOTHING_AGENT_NAME = "tracks.singlePlayer.simple.doNothing.MCTSVoice";
